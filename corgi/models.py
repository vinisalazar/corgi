...
class ConvRecurrantClassifier(nn.Module):
    def __init__(
        ...
        self.max_pool_1 = nn.MaxPool1d(
            kernel_size = kernel_size_maxpool
        )  
    ...
    def forward(self, x):
        ...
        ## Convolutional Layer
        ######################## 
        x = x.transpose(1, 2) # Transpose seq_len with embedding dims to suit convention of pytorch CNNs (batch_size, input_size, seq_len)
